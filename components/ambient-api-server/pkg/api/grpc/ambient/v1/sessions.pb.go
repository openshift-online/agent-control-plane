...
type Session struct {
	...
	GatewayId                *string                `protobuf:"bytes,35,opt,name=gateway_id,json=gatewayId,proto3,oneof" json:"gateway_id,omitempty"`
	GatewayWorkspace         *string                `protobuf:"bytes,36,opt,name=gateway_workspace,json=gatewayWorkspace,proto3,oneof" json:"gateway_workspace,omitempty"`
	SandboxId                *string                `protobuf:"bytes,37,opt,name=sandbox_id,json=sandboxId,proto3,oneof" json:"sandbox_id,omitempty"`
	SandboxName              *string                `protobuf:"bytes,38,opt,name=sandbox_name,json=sandboxName,proto3,oneof" json:"sandbox_name,omitempty"`
	RuntimeBackend           *string                `protobuf:"bytes,39,opt,name=runtime_backend,json=runtimeBackend,proto3,oneof" json:"runtime_backend,omitempty"`
	RunnerGeneration         *string                `protobuf:"bytes,40,opt,name=runner_generation,json=runnerGeneration,proto3,oneof" json:"runner_generation,omitempty"`
	GatewayEndpoint          *string                `protobuf:"bytes,41,opt,name=gateway_endpoint,json=gatewayEndpoint,proto3,oneof" json:"gateway_endpoint,omitempty"`
	GatewayCredentialId      *string                `protobuf:"bytes,42,opt,name=gateway_credential_id,json=gatewayCredentialId,proto3,oneof" json:"gateway_credential_id,omitempty"`
	RuntimeStatus            *string                `protobuf:"bytes,43,opt,name=runtime_status,json=runtimeStatus,proto3,oneof" json:"runtime_status,omitempty"`
	RuntimeError             *string                `protobuf:"bytes,44,opt,name=runtime_error,json=runtimeError,proto3,oneof" json:"runtime_error,omitempty"`
	RuntimeDeleted           bool                   `protobuf:"varint,45,opt,name=runtime_deleted,json=runtimeDeleted,proto3" json:"runtime_deleted,omitempty"`
	RuntimeVersion           int64                  `protobuf:"varint,46,opt,name=runtime_version,json=runtimeVersion,proto3" json:"runtime_version,omitempty"`
...
func (x *Session) GetGatewayWorkspace() string {
	if x != nil && x.GatewayWorkspace != nil {
		return *x.GatewayWorkspace
	}
	return ""
}
...
func (x *Session) GetSandboxName() string {
	if x != nil && x.SandboxName != nil {
		return *x.SandboxName
	}
	return ""
}

func (x *Session) GetRuntimeBackend() string {
...
func (x *Session) GetRunnerGeneration() string {
	if x != nil && x.RunnerGeneration != nil {
		return *x.RunnerGeneration
	}
	return ""
}

func (x *Session) GetGatewayEndpoint() string {
	if x != nil && x.GatewayEndpoint != nil {
		return *x.GatewayEndpoint
	}
	return ""
}

func (x *Session) GetGatewayCredentialId() string {
	if x != nil && x.GatewayCredentialId != nil {
		return *x.GatewayCredentialId
	}
	return ""
}

func (x *Session) GetRuntimeStatus() string {
	if x != nil && x.RuntimeStatus != nil {
		return *x.RuntimeStatus
	}
	return ""
}

func (x *Session) GetRuntimeError() string {
...
func (x *Session) GetRuntimeDeleted() bool {
	if x != nil {
		return x.RuntimeDeleted
	}
	return false
}

func (x *Session) GetRuntimeVersion() int64 {
	if x != nil {
...
const file_ambient_v1_sessions_proto_rawDesc = "" +
	...
	"ambient.v1\x1a\x17ambient/v1/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xce\x15\n" +
	"\aSession\x12\"\n" +
	"\n" +
	"gateway_id\x18# \x01(\tH\x00R\tgatewayId\x88\x01\x01\x120\n" +
	"\x11gateway_workspace\x18$ \x01(\tH\x01R\x10gatewayWorkspace\x88\x01\x01\x12\"\n" +
	"\n" +
	"sandbox_id\x18% \x01(\tH\x02R\tsandboxId\x88\x01\x01\x12&\n" +
	"\fsandbox_name\x18& \x01(\tH\x03R\vsandboxName\x88\x01\x01\x12,\n" +
	"\x0fruntime_backend\x18' \x01(\tH\x04R\x0eruntimeBackend\x88\x01\x01\x120\n" +
	"\x11runner_generation\x18( \x01(\tH\x05R\x10runnerGeneration\x88\x01\x01\x12.\n" +
	"\x10gateway_endpoint\x18) \x01(\tH\x06R\x0fgatewayEndpoint\x88\x01\x01\x127\n" +
	"\x15gateway_credential_id\x18* \x01(\tH\aR\x13gatewayCredentialId\x88\x01\x01\x12*\n" +
	"\x0eruntime_status\x18+ \x01(\tH\bR\rruntimeStatus\x88\x01\x01\x12(\n" +
	"\rruntime_error\x18, \x01(\tH\tR\fruntimeError\x88\x01\x01\x12'\n" +
	"\x0fruntime_deleted\x18- \x01(\bR\x0eruntimeDeleted\x12'\n" +
	"\x0fruntime_version\x18. \x01(\x03R\x0eruntimeVersion\x127\n" +
	"\bmetadata\x18\x01 \x01(\v2\x1b.ambient.v1.ObjectReferenceR\bmetadata\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1e\n" +
	"\brepo_url\x18\x03 \x01(\tH\n" +
	"R\arepoUrl\x88\x01\x01\x12\x1b\n" +
	"\x06prompt\x18\x04 \x01(\tH\vR\x06prompt\x88\x01\x01\x120\n" +
	"\x12created_by_user_id\x18\x05 \x01(\tH\fR\x0fcreatedByUserId\x88\x01\x01\x12-\n" +
	"\x10assigned_user_id\x18\x06 \x01(\tH\rR\x0eassignedUserId\x88\x01\x01\x12$\n" +
	"\vworkflow_id\x18\a \x01(\tH\x0eR\n" +
	"workflowId\x88\x01\x01\x12\x19\n" +
	"\x05repos\x18\b \x01(\tH\x0fR\x05repos\x88\x01\x01\x12\x1d\n" +
	"\atimeout\x18\n" +
	" \x01(\x05H\x10R\atimeout\x88\x01\x01\x12 \n" +
	"\tllm_model\x18\v \x01(\tH\x11R\bllmModel\x88\x01\x01\x12,\n" +
	"\x0fllm_temperature\x18\f \x01(\x01H\x12R\x0ellmTemperature\x88\x01\x01\x12)\n" +
	"\x0ellm_max_tokens\x18\r \x01(\x05H\x13R\fllmMaxTokens\x88\x01\x01\x12/\n" +
	"\x11parent_session_id\x18\x0e \x01(\tH\x14R\x0fparentSessionId\x88\x01\x01\x12-\n" +
	"\x10bot_account_name\x18\x0f \x01(\tH\x15R\x0ebotAccountName\x88\x01\x01\x122\n" +
	"\x12resource_overrides\x18\x10 \x01(\tH\x16R\x11resourceOverrides\x88\x01\x01\x128\n" +
	"\x15environment_variables\x18\x11 \x01(\tH\x17R\x14environmentVariables\x88\x01\x01\x12\x1b\n" +
	"\x06labels\x18\x12 \x01(\tH\x18R\x06labels\x88\x01\x01\x12%\n" +
	"\vannotations\x18\x13 \x01(\tH\x19R\vannotations\x88\x01\x01\x12\"\n" +
	"\n" +
	"project_id\x18\x14 \x01(\tH\x1aR\tprojectId\x88\x01\x01\x12\x19\n" +
	"\x05phase\x18\x15 \x01(\tH\x1bR\x05phase\x88\x01\x01\x12>\n" +
	"\n" +
	"start_time\x18\x16 \x01(\v2\x1a.google.protobuf.TimestampH\x1cR\tstartTime\x88\x01\x01\x12H\n" +
	"\x0fcompletion_time\x18\x17 \x01(\v2\x1a.google.protobuf.TimestampH\x1dR\x0ecompletionTime\x88\x01\x01\x12)\n" +
	"\x0esdk_session_id\x18\x18 \x01(\tH\x1eR\fsdkSessionId\x88\x01\x01\x12/\n" +
	"\x11sdk_restart_count\x18\x19 \x01(\x05H\x1fR\x0fsdkRestartCount\x88\x01\x01\x12#\n" +
	"\n" +
	"conditions\x18\x1a \x01(\tH R\n" +
	"conditions\x88\x01\x01\x12.\n" +
	"\x10reconciled_repos\x18\x1b \x01(\tH!R\x0freconciledRepos\x88\x01\x01\x124\n" +
	"\x13reconciled_workflow\x18\x1c \x01(\tH\"R\x12reconciledWorkflow\x88\x01\x01\x12%\n" +
	"\fkube_cr_name\x18\x1d \x01(\tH#R\n" +
	"kubeCrName\x88\x01\x01\x12#\n" +
	"\vkube_cr_uid\x18\x1e \x01(\tH$R\tkubeCrUid\x88\x01\x01\x12*\n" +
	"\x0ekube_namespace\x18\x1f \x01(\tH%R\rkubeNamespace\x88\x01\x01\x12\x1e\n" +
	"\bagent_id\x18  \x01(\tH&R\aagentId\x88\x01\x01\x12I\n" +
	"\x10last_activity_at\x18! \x01(\v2\x1a.google.protobuf.TimestampH'R\x0elastActivityAt\x88\x01\x01\x12B\n" +
	"\x1bsource_scheduled_session_id\x18\" \x01(\tH(R\x18sourceScheduledSessionId\x88\x01\x01B\r\n" +
	"\v_gateway_idB\x14\n" +
	"\x12_gateway_workspaceB\r\n" +
	"\v_sandbox_idB\x0f\n" +
	"\r_sandbox_nameB\x12\n" +
	"\x10_runtime_backendB\x14\n" +
	"\x12_runner_generationB\x13\n" +
	"\x11_gateway_endpointB\x18\n" +
	"\x16_gateway_credential_idB\x11\n" +
	"\x0f_runtime_statusB\x10\n" +
	"\x0e_runtime_errorB\v\n" +
	"\t_repo_urlB\t\n" +
	"\a_promptB\x15\n" +
