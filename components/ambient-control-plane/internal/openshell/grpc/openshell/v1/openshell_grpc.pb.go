...
import (
	context "context"
	v1 "github.com/openshift-online/agent-control-plane/components/ambient-control-plane/internal/openshell/grpc/openshell/sandbox/v1"
...
type OpenShellClient interface {
	...
	// Lifecycle RPCs from opendatahub-io/openshell at 681c9b2d8b9887f230cee4871bdbdbc9a362dfc8.
	...
	GetSandboxConfig(ctx context.Context, in *v1.GetSandboxConfigRequest, opts ...grpc.CallOption) (*v1.GetSandboxConfigResponse, error)
	// Get gateway-global settings.
	GetGatewayConfig(ctx context.Context, in *v1.GetGatewayConfigRequest, opts ...grpc.CallOption) (*v1.GetGatewayConfigResponse, error)
...
func (c *openShellClient) GetSandboxConfig(ctx context.Context, in *v1.GetSandboxConfigRequest, opts ...grpc.CallOption) (*v1.GetSandboxConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.GetSandboxConfigResponse)
...
func (c *openShellClient) GetGatewayConfig(ctx context.Context, in *v1.GetGatewayConfigRequest, opts ...grpc.CallOption) (*v1.GetGatewayConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.GetGatewayConfigResponse)
...
type OpenShellServer interface {
	...
	// Get sandbox settings by id (called by sandbox entrypoint and poll loop).
	GetSandboxConfig(context.Context, *v1.GetSandboxConfigRequest) (*v1.GetSandboxConfigResponse, error)
	// Get gateway-global settings.
	GetGatewayConfig(context.Context, *v1.GetGatewayConfigRequest) (*v1.GetGatewayConfigResponse, error)
	// Update settings or policy at sandbox or global scope.
...
func (UnimplementedOpenShellServer) GetSandboxConfig(context.Context, *v1.GetSandboxConfigRequest) (*v1.GetSandboxConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSandboxConfig not implemented")
}
func (UnimplementedOpenShellServer) GetGatewayConfig(context.Context, *v1.GetGatewayConfigRequest) (*v1.GetGatewayConfigResponse, error) {
...
func _OpenShell_GetSandboxConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.GetSandboxConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenShellServer).GetSandboxConfig(ctx, req.(*v1.GetSandboxConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OpenShell_GetGatewayConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.GetGatewayConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenShellServer).GetGatewayConfig(ctx, req.(*v1.GetGatewayConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
