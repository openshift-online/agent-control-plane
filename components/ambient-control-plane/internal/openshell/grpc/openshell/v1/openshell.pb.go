...
// Subset: only sandbox lifecycle and provider management RPCs needed by the control plane.
...
const file_openshell_v1_openshell_proto_rawDesc = "" +
	...
	"\x15SANDBOX_PHASE_UNKNOWN\x10\x052\xe0\x04\n" +
	"\tOpenShell\x12R\n" +
	...
	"\rDeleteSandbox\x12\".openshell.v1.DeleteSandboxRequest\x1a#.openshell.v1.DeleteSandboxResponse\x12U\n" +
...
var file_openshell_v1_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_openshell_v1_openshell_proto_goTypes = []any{
	...
	nil,                            // 19: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                            // 20: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                            // 21: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                            // 22: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                            // 23: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                            // 24: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	(*v1.ObjectMeta)(nil),          // 25: openshell.datamodel.v1.ObjectMeta
	(*v11.SandboxPolicy)(nil),      // 26: openshell.sandbox.v1.SandboxPolicy
	(*v1.Provider)(nil),            // 27: openshell.datamodel.v1.Provider
}
var file_openshell_v1_openshell_proto_depIdxs = []int32{
	25, // 0: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	19, // 3: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	3,  // 4: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	26, // 5: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	20, // 6: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	21, // 7: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	22, // 8: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	...
	23, // 12: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	1,  // 13: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	27, // 14: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	27, // 15: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	24, // 16: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	27, // 17: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	27, // 18: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	6,  // 19: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	7,  // 20: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	8,  // 21: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	11, // 22: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	14, // 23: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	12, // 24: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	13, // 25: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	9,  // 26: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	9,  // 27: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	10, // 28: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	15, // 29: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	15, // 30: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	15, // 31: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	16, // 32: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
