...
func (b *GatewayBuilder) Database(v *GatewayDatabase) *GatewayBuilder {
	b.resource.Database = v
	return b
}
...
func (b *GatewayPatchBuilder) Database(v *GatewayDatabase) *GatewayPatchBuilder {
	b.patch["database"] = v
	return b
}
