...
import (
	...
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/agent"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/ambient"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/application"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/apply"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/completion"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/config"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/create"
	...
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/logout"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/policy"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/project"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/provider"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/scheduledsession"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/session"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/start"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/stop"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/version"
	"github.com/openshift-online/agent-control-plane/components/ambient-cli/cmd/acpctl/whoami"
